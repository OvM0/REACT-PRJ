    ...
    return (
      <div className="py-5">
        <div className="container text-center py-5">
          ...
          <h2 className="fw-bold mb-2" style={{ color: '#1a1a2e' }}>No orders yet</h2>
          <p className="text-muted mb-4">Start your fresh shopping journey now and your orders will appear here!</p>
      ...
      <div className="container">
        <div className="mb-4">
          <h1 className="fw-bold" style={{ color: '#1a1a2e' }}>
            <i className="fas fa-box me-2 text-success"></i>My Orders
          </h1>
          <p className="text-muted">{orders.length} orders found in your history</p>
        </div>
                  ...
                  <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                    <div>
                      <h6 className="fw-bold mb-1">
                        ...
                        Order ID: <span className="text-success">{order.id || order._id?.slice(-6)}</span>
                      </h6>
                      ...
                      {order.cartItems?.length > 4 && (
                        <div className="col-6 col-md-3">
                          <div className="d-flex align-items-center justify-content-center p-2 rounded-3 h-100"
                            ...
                            <p className="text-muted mb-0 small">+{order.cartItems.length - 4} more items</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 pt-3 border-top">
                    <div className="d-flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="fw-semibold mb-0">{order.cartItems?.length} items</p>
                      </div>
                    </div>
